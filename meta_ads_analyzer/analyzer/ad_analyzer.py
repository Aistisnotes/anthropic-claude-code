    ...
    async def analyze_batch(self, ads: list[AdContent]) -> dict[str, AdAnalysis | None]:
        ...
        async def _analyze_one(ad: AdContent):
            ...
            async with semaphore:
                _counter += 1
                logger.info(f"Analyzing ad {_counter}/{_total} ({ad.ad_id})")
    ...
    def _parse_response(self, ad: AdContent, response_text: str) -> Optional[AdAnalysis]:
        ...
        try:
            ...
            return AdAnalysis(
                ...
                creative_format=data.get("creative_format", ""),
                mechanism=data.get("mechanism", ""),
                mechanism_depth=data.get("mechanism_depth", ""),
                scientific_note=data.get("scientific_note", ""),
